...
import com.authentication.auth_app_backend.exceptions.ResourceNotFoundException;
import com.authentication.auth_app_backend.helpers.UserHelper;
...
public class UserServiceImpl implements UserService {
  ...
  public UserDto createUser(UserDto userDto) {
    ...
    // cover extra checks if required

    User user = modelMapper.map(userDto, User.class);
    user.setProvider(userDto.getProvider() != null ? userDto.getProvider() : Provider.LOCAL);
    // role assigns here to user___for authorization
    // TODO:
